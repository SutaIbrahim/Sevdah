...
{
    public class KontoDobavljacReport
    {
        int _totalColumns = 5;
        Document _document;
        Font _fontStyle;
        ...
        DobavljacKontoKartica _redovi = new DobavljacKontoKartica();
        ...
        private void ReportHeader()
        {
            ...
            _fontStyle = FontFactory.GetFont("Tahoma", 11f, 1);
            _pdfPCell = new PdfPCell(new Phrase(_redovi.NazivDobavljaca, _fontStyle));
            _pdfPCell.Colspan = _totalColumns;
            _pdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT;
            _pdfPCell.Border = 0;
            _pdfPCell.BackgroundColor = BaseColor.WHITE;
            ...
            _fontStyle = FontFactory.GetFont("Tahoma", 11f, 1);
            _pdfPCell = new PdfPCell(new Phrase(_redovi.AdresaDobavljaca + "," + _redovi.Grad, _fontStyle));
            _pdfPCell.Colspan = _totalColumns;
            _pdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT;
            _pdfPCell.Border = 0;
            _pdfPCell.BackgroundColor = BaseColor.WHITE;
        ...
        _fontStyle1 = FontFactory.GetFont("Tahoma", 12f, 1);
            ...
            _pdfPCell = new PdfPCell(new Phrase(Math.Round((_redovi.prethodnoDugovanje +_redovi.Saldo),2).ToString() + " KM", _fontStyle1));
            _pdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT;
            _pdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _pdfPCell.BackgroundColor = BaseColor.LIGHT_GRAY;
            _pdfPCell.PaddingTop = 7f;
