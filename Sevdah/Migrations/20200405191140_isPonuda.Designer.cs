...
namespace Sevdah.Migrations
{
    ...
    [Migration("20200405191140_isPonuda")]
    partial class isPonuda
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sevdah.Models.Otpremnica", b =>
                {
            ...
            modelBuilder.Entity("Sevdah.Models.OtpremnicaProizvod", b =>
                {
                    b.Property<int>("OtpremnicaProizvodID")
                        .ValueGeneratedOnAdd();
                    ...
                    b.HasKey("OtpremnicaProizvodID");

                    b.HasIndex("OtpremnicaID");

                    b.HasIndex("ProizvodID");

                    b.ToTable("OtpremnicaProizvod");
                });
            ...
            modelBuilder.Entity("Sevdah.Models.OtpremnicaProizvod", b =>
                {
                    b.HasOne("Sevdah.Models.Otpremnica", "Otpremnica")
                        .WithMany()
